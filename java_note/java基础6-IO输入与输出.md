...
- [输入/输出流](#输入输出流)
  ...
  - [常用API](#常用api)
    ...
    - [java.io.InputStream](#javaioinputstream)
      - [abstract int read()](#abstract-int-read)
      - [int read(byte[] b)](#int-readbyte-b)
      - [int readNBytes(byte[] b,int off,int len)](#int-readnbytesbyte-bint-offint-len)
      - [byte[] readAllBytes()](#byte-readallbytes)
      - [long transferTo(OutputStream out)](#long-transfertooutputstream-out)
      - [long skip(long n)](#long-skiplong-n)
      - [int avialable()](#int-avialable)
      - [void close()](#void-close)
      - [void mark(int readlimit)](#void-markint-readlimit)
      - [void reset()](#void-reset)
      - [boolean markSupported()](#boolean-marksupported)
    - [java.io.OutputStream](#javaiooutputstream)
      - [abstract void write(int n)](#abstract-void-writeint-n)
      - [void write(byte[] b,int off,int len)](#void-writebyte-bint-offint-len)
      - [void close()](#void-close-1)
      - [void flush()](#void-flush)
  - [完整的流家族](#完整的流家族)
    - [常用API](#常用api-1)
      - [java.io.Closeable](#javaiocloseable)
        - [void close()](#void-close-2)
      - [java.io.Flushable](#javaioflushable)
        - [void flush()](#void-flush-1)
      - [java.lang.Readable](#javalangreadable)
        - [int read(CharBuffer cb)](#int-readcharbuffer-cb)
      - [java.lang.Appendable](#javalangappendable)
      - [java.lang.CharSequnece](#javalangcharsequnece)
        - [char charAt(int index)](#char-charatint-index)
        - [int length()](#int-length)
        - [CharSequence subSequnce(int startIndex,int Index)](#charsequence-subsequnceint-startindexint-index)
        - [String toString()](#string-tostring)
  - [组合输入/输出流过滤器](#组合输入输出流过滤器)
    - [两个注意的点：](#两个注意的点)
    - [常用API](#常用api-2)
      - [java.io.FileInputStream](#javaiofileinputstream)
        - [FileInputStream(File file)](#fileinputstreamfile-file)
      - [java.io.FileOutputStream](#javaiofileoutputstream)
        - [FileOutputStream(File file,boolean append)](#fileoutputstreamfile-fileboolean-append)
      - [java.io.BufferedInputStream](#javaiobufferedinputstream)
        - [BufferedInputStream(InputStream in)](#bufferedinputstreaminputstream-in)
      - [java.io.BufferedOutputStream](#javaiobufferedoutputstream)
        - [BufferedOutputStream(OutputStream out)](#bufferedoutputstreamoutputstream-out)
      - [java.io.PushbackInputStream](#javaiopushbackinputstream)
        - [PushbackInputStream(InputStream in,int size)](#pushbackinputstreaminputstream-inint-size)
        - [void unread()](#void-unread)
  - [文本输入与输出](#文本输入与输出)
  - [如何写出文本输出](#如何写出文本输出)
    - [常用API](#常用api-3)
      - [java.io.PrintWriter](#javaioprintwriter)
        - [PrintWriter(Writer writer)](#printwriterwriter-writer)
        - [Printer(File file,String encoding)](#printerfile-filestring-encoding)
        - [void print(Object obj)](#void-printobject-obj)
        - [void print(String s)](#void-printstring-s)
        - [void println(String s)](#void-printlnstring-s)
        - [void print(char[] s)](#void-printchar-s)
        - [void print(char c)](#void-printchar-c)
        - [void printf(String format,Object...args)](#void-printfstring-formatobjectargs)
        - [boolean checkError()](#boolean-checkerror)
  - [如何读入文本输入](#如何读入文本输入)
  - [以文本格式存储对象](#以文本格式存储对象)
  - [字符编码方式](#字符编码方式)
- [读写二进制数据](#读写二进制数据)
  - [DataInput和DataOutput接口](#datainput和dataoutput接口)
    - [常用API](#常用api-4)
      - [java.io.DataInput](#javaiodatainput)
        - [int readInt()](#int-readint)
        - [void readFully(byte[] b)](#void-readfullybyte-b)
        - [void readFully(byte[] b,int off,int len)](#void-readfullybyte-bint-offint-len)
      - [java.io.DataOutput](#javaiodataoutput)
        - [void writeInt(int i)](#void-writeintint-i)
  - [随机访问文件](#随机访问文件)
  - [ZIP文档](#zip文档)
    - [常用API](#常用api-5)
      - [java.io.ZipInputStream](#javaiozipinputstream)
      - [java.io.ZipOutputStream](#javaiozipoutputstream)
      - [java.util.zip.ZipEntry](#javautilzipzipentry)
        - [ZipEntry(String name)](#zipentrystring-name)
      - [java.io.zip.ZipFile](#javaiozipzipfile)
- [对象输入/输出序列化](#对象输入输出序列化)
  - [保存和加载序列化对象](#保存和加载序列化对象)
    - [常用API](#常用api-6)
      - [java.io.ObjectOutputStream](#javaioobjectoutputstream)
        - [ObjectOutputStream(OutputStream out)](#objectoutputstreamoutputstream-out)
        - [void writeObject(Object obj)](#void-writeobjectobject-obj)
      - [java.io.ObjectInputStream](#javaioobjectinputstream)
        - [ObjectInputStream(InputStream in)](#objectinputstreaminputstream-in)
        - [Object readObject()](#object-readobject)
  - [理解对象序列化的文件格式](#理解对象序列化的文件格式)
    - [几个注意的点:](#几个注意的点)
  - [修改默认的序列化机制](#修改默认的序列化机制)
    - [类定义自己的机制来保存和加载对象](#类定义自己的机制来保存和加载对象)
  - [序列化单例和类型安全的枚举](#序列化单例和类型安全的枚举)
  - [版本管理](#版本管理)
  - [为克隆使用序列化](#为克隆使用序列化)
- [操作文件](#操作文件)
  - [Path](#path)
    - [常用API](#常用api-7)
      - [java.nio.file.Paths](#javaniofilepaths)
        - [static Path ge(String first,String ..more)](#static-path-gestring-firststring-more)
      - [java.nio.file.Path](#javaniofilepath)
        - [Path resovle(String other)](#path-resovlestring-other)
        - [Path relativize(Path other)](#path-relativizepath-other)
  ...
  - [读写文件](#读写文件)
    - [常用API](#常用api-8)
      - [java.nio.file.Files](#javaniofilefiles)
        - [static List\<String> readAllLines(Path path,Charset charset)](#static-liststring-readalllinespath-pathcharset-charset)
        - [staic Path write(Path path,Iterable<? extends CharSequence> contents,OpenOption options)](#staic-path-writepath-pathiterable-extends-charsequence-contentsopenoption-options)
        - [static BufferedWriter newBufferedWriter(Path path,Charset charset,OpenOption... options)](#static-bufferedwriter-newbufferedwriterpath-pathcharset-charsetopenoption-options)
  - [创建文件和目录](#创建文件和目录)
    - [常用API](#常用api-9)
      - [java.nio.file.Files](#javaniofilefiles-1)
        - [static Path createDirectories(Path path,FileAtrribute<?>...attrs)](#static-path-createdirectoriespath-pathfileatrributeattrs)
  - [复制、移动和删除文件](#复制移动和删除文件)
    - [常用API](#常用api-10)
      - [java.nio.file.Files](#javaniofilefiles-2)
        - [static Path move(Path from,Path to,CopyOption...options)](#static-path-movepath-frompath-tocopyoptionoptions)
        - [static long copy(Path from,OutputStream to,CopyOption ...options)](#static-long-copypath-fromoutputstream-tocopyoption-options)
        - [static boolean deleteIfExists(Path path)](#static-boolean-deleteifexistspath-path)
  - [获取文件信息](#获取文件信息)
    - [常用API](#常用api-11)
      - [java.nio.file.Files](#javaniofilefiles-3)
        - [static boolean isSymbolicLink(Path path)](#static-boolean-issymboliclinkpath-path)
          - [static long size(Path path)](#static-long-sizepath-path)
        - [A readAttributes(Path path,Class\<A> type,LinkOption...options)](#a-readattributespath-pathclassa-typelinkoptionoptions)
      - [java.nio.file.attribute.BasicFileAttributes](#javaniofileattributebasicfileattributes)
  - [访问目录中的项](#访问目录中的项)
  - [使用目录流](#使用目录流)
    - [常用API](#常用api-12)
      - [java.nio.file.Files](#javaniofilefiles-4)
        - [static DirectoryStream\<Path> newDirectoryStream(Path path,String glob)](#static-directorystreampath-newdirectorystreampath-pathstring-glob)
        - [static Path walkFileTree(Path start,FileVisitor<? super Path> visiotr)](#static-path-walkfiletreepath-startfilevisitor-super-path-visiotr)
      - [java.nio.SimpleFIleVisitor\<T>](#javaniosimplefilevisitort)
        - [static FileVisitResult visitFile(T path,BasicFileAttributes attrs)](#static-filevisitresult-visitfilet-pathbasicfileattributes-attrs)
    - [常用API](#常用api-13)
      - [java.nio.file.FileSystems](#javaniofilefilesystems)
- [内存映射文件](#内存映射文件)
  - [内存映射文件的性能](#内存映射文件的性能)
    - [常用API](#常用api-14)
      - [java.io.FileInputStream](#javaiofileinputstream-1)
        - [FileChannel getChannel()](#filechannel-getchannel)
      - [java.io.FileOutputStream](#javaiofileoutputstream-1)
        - [FileChannel getChannel()](#filechannel-getchannel-1)
      - [java.io.RandomAccessFile](#javaiorandomaccessfile)
        - [FileChannel getChannel()](#filechannel-getchannel-2)
      - [java.nio.channels.FileChannel](#javaniochannelsfilechannel)
        - [staic FileChannel open(Path path,OpenOption...options)](#staic-filechannel-openpath-pathopenoptionoptions)
        - [MappedByteBuffer(FileChannel.MapMode mode,long position,long size)](#mappedbytebufferfilechannelmapmode-modelong-positionlong-size)
      - [java.io.Buffer](#javaiobuffer)
      - [boolean hasRemaing()](#boolean-hasremaing)
        - [int limit()](#int-limit)
      - [java.io.ByteBuffer](#javaiobytebuffer)
        - [byte get()](#byte-get)
        - [byte get(int index)](#byte-getint-index)
        - [ByteBuffer put(byte b)](#bytebuffer-putbyte-b)
        - [ByteBuffer put(int index,byte b)](#bytebuffer-putint-indexbyte-b)
        - [ByteBuffer get(byte[] destination,int offset,int length)](#bytebuffer-getbyte-destinationint-offsetint-length)
        - [ByBuffer put(byte[] source,int offset,int length)](#bybuffer-putbyte-sourceint-offsetint-length)
        - [ByteBuffer putXXX(int index,Xxx value)](#bytebuffer-putxxxint-indexxxx-value)
        - [ByteOrder order()](#byteorder-order)
        - [static ByteBuffer allocate(int capacity)](#static-bytebuffer-allocateint-capacity)
        - [static ByteBuffer wrap(byte[] values)](#static-bytebuffer-wrapbyte-values)
      - [java.nio.CharBuffer](#javaniocharbuffer)
        - [CharBuffer get(char[] destination,int offsets,int length)](#charbuffer-getchar-destinationint-offsetsint-length)
        - [CharBuffer put(CharBuffer source)](#charbuffer-putcharbuffer-source)
  - [缓冲区的数据结构](#缓冲区的数据结构)
    - [常用API](#常用api-15)
      - [java.nio.Buffer](#javaniobuffer)
        - [Buffer clear()](#buffer-clear)
        - [Buffer filp()](#buffer-filp)
        - [Buffer rewind()](#buffer-rewind)
        - [Buffer mark()](#buffer-mark)
        - [Buffer reset()](#buffer-reset)
        - [int remaing()](#int-remaing)
        - [void position(int newValue)](#void-positionint-newvalue)
        - [int capacity()](#int-capacity)
- [文件加锁机制](#文件加锁机制)
    - [常用API](#常用api-16)
      - [java.nio.channels.FileChannel](#javaniochannelsfilechannel-1)
        - [FileLock lock()](#filelock-lock)
        - [FileLock tryLock()](#filelock-trylock)
        - [FileLock tryLock(long position,long size,boolean shared)](#filelock-trylocklong-positionlong-sizeboolean-shared)
      - [java.nio.channels.FileLock](#javaniochannelsfilelock)
        - [void close()](#void-close-3)
- [正则表达式](#正则表达式)
  - [正则表达式语法](#正则表达式语法)
  - [匹配字符串](#匹配字符串)
  - [找出多个匹配](#找出多个匹配)
