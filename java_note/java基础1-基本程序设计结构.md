...
1.打开终端- [一个简单的Java应用程序](#一个简单的java应用程序)
- [一个简单的Java应用程序](#一个简单的java应用程序)
- [命令行运行](#命令行运行)
- [注释](#注释)
- [数据类型](#数据类型)
  - [八个基本类型](#八个基本类型)
...
- [字符串](#字符串)
  ...
  - [String API](#string-api)
    - [java.lang.String](#javalangstring)
      ...
      - [int codePointAt(int index)](#int-codepointatint-index)
      - [int offset(int startIndex,int cpCount)](#int-offsetint-startindexint-cpcount)
      - [boolean empty()](#boolean-empty)
      - [boolean equals(String other)](#boolean-equalsstring-other)
      - [int length()](#int-length)
      - [int codePointCount(int startIndex,int endIndex)](#int-codepointcountint-startindexint-endindex)
      - [String replace(CharSequence oldString,CharSequence newString)](#string-replacecharsequence-oldstringcharsequence-newstring)
      - [String subString(int beginIndex,int endIndex)](#string-substringint-beginindexint-endindex)
      - [String toUpperCase()](#string-touppercase)
      - [String join(CharSequence delimiter,CharSequence ...elements)](#string-joincharsequence-delimitercharsequence-elements)
  - [阅读文档](#阅读文档)
  - [构建字符串](#构建字符串)
- [输入与输出](#输入与输出)
  - [读取输入](#读取输入)
    ...
    - [java.util.Scanner](#javautilscanner)
      - [Scanner(InputStream in)](#scannerinputstream-in)
      ...
      - [boolean hasNextDouble()](#boolean-hasnextdouble)
  - [格式化与输出](#格式化与输出)
  - [文件输入与输出](#文件输入与输出)
- [控制流程](#控制流程)
  - [块作用域](#块作用域)
